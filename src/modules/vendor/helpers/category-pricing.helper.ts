export class CategoryPricingHelper {
  ...
  /**
   * Generate category-specific pricing array
  ...
  static generateCategoryPricing(categoryName: string): Array<{ title: string; price: number }> {
    ...
    if (normalizedCategoryName.includes('venue') || normalizedCategoryName.includes('hall') || normalizedCategoryName.includes('banquet')) {
      return [
